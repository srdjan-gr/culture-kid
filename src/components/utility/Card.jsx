  ...
  return (
    <div className="flex flex-col items-start justify-center w-80  p-8 hover:shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px]  my-5">
      ...
      <div className="mt-5 font-karla_font">
        ...
        <p className="text-l text-gray-400">{image.artist}</p>
        <p className="text-l text-gray-400 italic">
          {image.technique}, {image.year}
        </p>
      </div>

      <div className="w-full mt-8 flex justify-between items-center invisible hover:visible">
        <h3 className=" text-xl">
          {"$"}
          {image.price}
        </h3>
        <div className="flex gap-2">
          <BsBoxArrowUp className="bg-gray-200 text-kid_black w-8 h-8 p-[6px] cursor-pointer" />
